...
- **Hospital Data Analysis (SQL):** Analyzed hospital data using SQL to generate insights on patients, doctors, departments, medical expenses, hospital stays, and monthly performance using MySQL queries.

- **Vrinda Store Sales Analysis (Excel):** Created an interactive Excel dashboard using Pivot Tables, charts, KPIs, data cleaning, and analysis to identify sales trends, customer behavior, and business performance.
